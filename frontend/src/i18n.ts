...
const en: Dict = {
  ...
  'map.empty': 'No calls observed between services yet \u2014 edges appear as apps make HTTP calls through Boot-built clients.',
  'map.legendOk': 'healthy',
  'map.legendSlow': 'slowest edge',
  'map.legend5xx': 'has 5xx',
  'map.legendHint': 'Arrow width = call rate \u00b7 click a node to open it',
  'outbound.inboundTitle': '\u2190 Called by ({n})',
  'outbound.title': '\u2192 Outbound calls',
  'outbound.empty': 'No outbound HTTP metrics from this app \u2014 collected automatically when it calls other services via Boot-built clients (RestTemplateBuilder / WebClient.Builder / RestClient.Builder).',
  'outbound.target': 'Calls',
  'outbound.rps': 'req/s',
  'outbound.calls': 'total',
  'outbound.avg': 'avg latency',
  'outbound.max': 'max',
  'outbound.jump': 'Open {name}',
  'outbound.external': 'Not on this wall (external)',
  'outbound.paths': 'Show paths',
  'outbound.noPaths': 'No per-path data.',
  'admin.silence.label': 'Silence for:',
  'admin.silence.preset': '{m} min',
  'admin.backup.delete': 'Delete backup',
  'admin.backup.deleteConfirm': 'Delete backup {name}? This cannot be undone.',
  'admin.backup.empty': 'No backups yet — take the first snapshot with "Back up now".',
  'admin.registry.state': 'State',
  'admin.registry.removeConfirm': 'Remove {name} from the wall? A running client will re-register on its next heartbeat.',
  'admin.rules.editHint': 'Click to edit the threshold',
  'admin.source.static': 'yaml',
  'admin.source.registered': 'self-registered',
  'admin.source.ui': 'UI',
  'admin.storage.title': 'Storage & backup',
  'admin.storage.disabled': 'History is off (ticker.history.enabled=false) \u2014 the board runs fully in-memory. Nothing to manage here.',
  'admin.storage.db': 'Database',
  'admin.storage.rows': 'Samples',
  'admin.storage.span': 'Data span',
  'admin.storage.file': 'H2 file',
  'admin.storage.retention': 'Retention',
  'admin.storage.archive': 'Archive',
  'admin.storage.archiveOn': 'on \u2014 {n} files, {size}',
  'admin.storage.archiveOff': 'off',
  'admin.backup.now': 'Back up now',
  'admin.backup.running': 'Backing up\u2026',
  'admin.backup.done': 'Backup written: {name} ({size}, {ms}ms)',
  'admin.backup.unsupported': 'Online backup is H2-only \u2014 use mysqldump --single-transaction / pg_dump for this database.',
  'admin.backup.file': 'File',
  'admin.backup.size': 'Size',
  'admin.backup.when': 'Created',
  'admin.backup.download': 'download',
  'admin.alerts.title': 'Silence & alerts',
  'admin.alerts.enabled': 'Alerting',
  'admin.alerts.webhook': 'Slack webhook',
  'admin.alerts.recent': 'Recent fires',
  'admin.silence.active': 'Silence active until {until}',
  'admin.silence.inactive': 'No silence window',
  'admin.silence.start': 'Silence',
  'admin.silence.clear': 'Lift silence',
  'admin.silence.minutes': 'minutes',
  'admin.silence.hint': 'Deploys are not incidents \u2014 silence dispatch during a rollout; anything still DOWN when the window ends is announced then.',
  'admin.rules.rule': 'Rule',
  'admin.rules.threshold': 'Threshold',
  'admin.rules.enabled': 'Enabled',
  'admin.registry.title': 'Target registry ({n})',
  'admin.registry.name': 'Name',
  'admin.registry.instance': 'Instance',
  'admin.registry.source': 'Source',
  'admin.registry.heartbeat': 'Last heartbeat',
  'admin.registry.remove': 'remove',
  'admin.collector.title': 'Collector',
  'admin.collector.pollInterval': 'Poll interval',
  'admin.collector.timeout': 'Poll timeout',
  'admin.collector.threshold': 'Failure threshold',
  'admin.collector.degraded': 'Degraded above',
  'admin.collector.basePath': 'Base path',
  'admin.collector.publicUrl': 'Public URL',
  'admin.collector.expiry': 'Registration expiry',
  'admin.collector.history': 'History',
  // App shell
  ...
  'metric.tomcat-global-request-avg.desc': 'Mean request time at the Tomcat connector (tomcat.global.request TOTAL_TIME / COUNT).',
  'metric.tomcat-global-request-avg.tip': 'Connector-level average latency, including request processing. A rising average means the web tier is slowing down.',
...
const ko: Dict = {
  ...
  'wall.map': '\ub9f5',
  'map.title': '\uc11c\ube44\uc2a4 \ub9f5',
  'map.empty': '\uc544\uc9c1 \uc11c\ube44\uc2a4 \uc0ac\uc774 \ud638\ucd9c\uc774 \uad00\uce21\ub418\uc9c0 \uc54a\uc558\uc2b5\ub2c8\ub2e4 \u2014 \uc571\ub4e4\uc774 Boot \ud074\ub77c\uc774\uc5b8\ud2b8\ub85c HTTP \ud638\ucd9c\uc744 \ud558\uba74 \ud654\uc0b4\ud45c\uac00 \uc0dd\uae41\ub2c8\ub2e4.',
  'map.legendOk': '\uc815\uc0c1',
  'map.legendSlow': '\uac00\uc7a5 \ub290\ub9b0 \uad6c\uac04',
  'map.legend5xx': '5xx \ubc1c\uc0dd',
  'map.legendHint': '\ud654\uc0b4\ud45c \uad75\uae30 = \ud638\ucd9c\ub7c9 \u00b7 \ub178\ub4dc \ud074\ub9ad = \uc0c1\uc138 \uc5f4\uae30',
  'outbound.inboundTitle': '\u2190 \ub098\ub97c \ubd80\ub974\ub294 \uc11c\ube44\uc2a4 ({n})',
  'outbound.title': '\u2192 \uc544\uc6c3\ubc14\uc6b4\ub4dc \ud638\ucd9c',
  'outbound.empty': '\uc774 \uc571\uc774 \ub0b4\ubcf4\ub0b4\ub294 \uc544\uc6c3\ubc14\uc6b4\ub4dc HTTP \uc9c0\ud45c\uac00 \uc5c6\uc2b5\ub2c8\ub2e4 \u2014 Boot\uac00 \ub9cc\ub4e0 \ud074\ub77c\uc774\uc5b8\ud2b8(RestTemplateBuilder / WebClient.Builder / RestClient.Builder)\ub85c \ub2e4\ub978 \uc11c\ube44\uc2a4\ub97c \ubd80\ub974\uba74 \uc790\ub3d9\uc73c\ub85c \uc7a1\ud799\ub2c8\ub2e4.',
  'outbound.target': '\ud638\ucd9c \ub300\uc0c1',
  'outbound.rps': '\ucd08\ub2f9',
  'outbound.calls': '\ub204\uc801',
  'outbound.avg': '\ud3c9\uade0 \uc9c0\uc5f0',
  'outbound.max': '\ucd5c\ub300',
  'outbound.jump': '{name} \uc5f4\uae30',
  'outbound.external': '\uc774 \ubcbd\uc5d0 \uc5c6\ub294 \ub300\uc0c1 (\uc678\ubd80)',
  'outbound.paths': '\uacbd\ub85c \ubcf4\uae30',
  'outbound.noPaths': '\uacbd\ub85c\ubcc4 \ub370\uc774\ud130 \uc5c6\uc74c.',
  'admin.silence.label': '\uc7a0\uc7ac\uc6b8 \uc2dc\uac04:',
  'admin.silence.preset': '{m}\ubd84',
  'admin.backup.delete': '\ubc31\uc5c5 \uc0ad\uc81c',
  'admin.backup.deleteConfirm': '\ubc31\uc5c5 {name}\uc744(\ub97c) \uc0ad\uc81c\ud560\uae4c\uc694? \ub418\ub3cc\ub9b4 \uc218 \uc5c6\uc2b5\ub2c8\ub2e4.',
  'admin.backup.empty': '\uc544\uc9c1 \ubc31\uc5c5\uc774 \uc5c6\uc2b5\ub2c8\ub2e4 \u2014 "\uc9c0\uae08 \ubc31\uc5c5"\uc73c\ub85c \uccab \uc2a4\ub0c5\uc0f7\uc744 \ub5a0\ubcf4\uc138\uc694.',
  'admin.registry.state': '\uc0c1\ud0dc',
  'admin.registry.removeConfirm': '{name}\uc744(\ub97c) \ubcbd\uc5d0\uc11c \uc81c\uac70\ud560\uae4c\uc694? \uc2e4\ud589 \uc911\uc778 \ud074\ub77c\uc774\uc5b8\ud2b8\ub294 \ub2e4\uc74c \ud558\ud2b8\ube44\ud2b8\uc5d0 \ub2e4\uc2dc \ub4f1\ub85d\ub429\ub2c8\ub2e4.',
  'admin.rules.editHint': '\ud074\ub9ad\ud574\uc11c \uc784\uacc4\uac12 \ud3b8\uc9d1',
  'admin.source.static': 'yaml',
  'admin.source.registered': '\uc790\uac00\ub4f1\ub85d',
  'admin.source.ui': 'UI',
  'admin.storage.title': '\uc800\uc7a5\uc18c & \ubc31\uc5c5',
  'admin.storage.disabled': '\ud788\uc2a4\ud1a0\ub9ac\uac00 \uaebc\uc838 \uc788\uc2b5\ub2c8\ub2e4 (ticker.history.enabled=false) \u2014 \ubcf4\ub4dc\ub294 \uc644\uc804\ud788 \uc778\uba54\ubaa8\ub9ac\ub85c \ub3d9\uc791 \uc911. \uad00\ub9ac\ud560 \uac8c \uc5c6\uc5b4\uc694.',
  'admin.storage.db': '\ub370\uc774\ud130\ubca0\uc774\uc2a4',
  'admin.storage.rows': '\uc0d8\ud50c \uc218',
  'admin.storage.span': '\ub370\uc774\ud130 \uae30\uac04',
  'admin.storage.file': 'H2 \ud30c\uc77c',
  'admin.storage.retention': '\ubcf4\uc874 \uae30\uac04',
  'admin.storage.archive': '\uc544\uce74\uc774\ube0c',
  'admin.storage.archiveOn': '\ucf1c\uc9d0 \u2014 \ud30c\uc77c {n}\uac1c, {size}',
  'admin.storage.archiveOff': '\uaebc\uc9d0',
  'admin.backup.now': '\uc9c0\uae08 \ubc31\uc5c5',
  'admin.backup.running': '\ubc31\uc5c5 \uc911\u2026',
  'admin.backup.done': '\ubc31\uc5c5 \uc644\ub8cc: {name} ({size}, {ms}ms)',
  'admin.backup.unsupported': '\uc628\ub77c\uc778 \ubc31\uc5c5\uc740 H2 \uc804\uc6a9\uc785\ub2c8\ub2e4 \u2014 \uc774 DB\ub294 mysqldump --single-transaction / pg_dump\ub97c \uc4f0\uc138\uc694.',
  'admin.backup.file': '\ud30c\uc77c',
  'admin.backup.size': '\ud06c\uae30',
  'admin.backup.when': '\uc0dd\uc131',
  'admin.backup.download': '\ub2e4\uc6b4\ub85c\ub4dc',
  'admin.alerts.title': '\uc0ac\uc77c\ub7f0\uc2a4 & \uc54c\ub9bc',
  'admin.alerts.enabled': '\uc54c\ub9bc',
  'admin.alerts.webhook': 'Slack \uc6f9\ud6c5',
  'admin.alerts.recent': '\ucd5c\uadfc \ubc1c\ud654',
  'admin.silence.active': '\uc0ac\uc77c\ub7f0\uc2a4 \ud65c\uc131 \u2014 {until}\uae4c\uc9c0',
  'admin.silence.inactive': '\uc0ac\uc77c\ub7f0\uc2a4 \uc5c6\uc74c',
  'admin.silence.start': '\uc0ac\uc77c\ub7f0\uc2a4 \uac78\uae30',
  'admin.silence.clear': '\uc0ac\uc77c\ub7f0\uc2a4 \ud574\uc81c',
  'admin.silence.minutes': '\ubd84',
  'admin.silence.hint': '\ubc30\ud3ec\ub294 \uc7a5\uc560\uac00 \uc544\ub2d9\ub2c8\ub2e4 \u2014 \ub864\uc544\uc6c3 \ub3d9\uc548 \ubc1c\uc1a1\uc744 \uc7a0\uc7ac\uc6b0\uace0, \ucc3d\uc774 \ub05d\ub0a0 \ub54c \uc5ec\uc804\ud788 DOWN\uc774\uba74 \uadf8\ub54c \uc54c\ub9bd\ub2c8\ub2e4.',
  'admin.rules.rule': '\uaddc\uce59',
  'admin.rules.threshold': '\uc784\uacc4\uac12',
  'admin.rules.enabled': '\ud65c\uc131',
  'admin.registry.title': '\ud0c0\uae43 \ub808\uc9c0\uc2a4\ud2b8\ub9ac ({n})',
  'admin.registry.name': '\uc774\ub984',
  'admin.registry.instance': '\uc778\uc2a4\ud134\uc2a4',
  'admin.registry.source': '\ucd9c\ucc98',
  'admin.registry.heartbeat': '\ub9c8\uc9c0\ub9c9 \ud558\ud2b8\ube44\ud2b8',
  'admin.registry.remove': '\uc81c\uac70',
  'admin.collector.title': '\ucef4\ub809\ud130',
  'admin.collector.pollInterval': '\ud3f4\ub9c1 \uc8fc\uae30',
  'admin.collector.timeout': '\ud3f4\ub9c1 \ud0c0\uc784\uc544\uc6c3',
  'admin.collector.threshold': '\uc5f0\uc18d \uc2e4\ud328 \uc784\uacc4',
  'admin.collector.degraded': 'DEGRADED \uae30\uc900',
  'admin.collector.basePath': 'Base path',
  'admin.collector.publicUrl': 'Public URL',
  'admin.collector.expiry': '\ub4f1\ub85d \ub9cc\ub8cc',
  'admin.collector.history': '\ud788\uc2a4\ud1a0\ub9ac',
  // App shell
  'app.sub': '서비스 상태 모니터',
  ...
  'metric.tomcat-global-request-avg.desc': 'Tomcat 커넥터의 평균 요청 처리 시간 (tomcat.global.request TOTAL_TIME / COUNT).',
  'metric.tomcat-global-request-avg.tip': '커넥터 수준의 평균 지연 시간(요청 처리 포함). 평균이 상승하면 웹 티어가 느려지는 것입니다.',
